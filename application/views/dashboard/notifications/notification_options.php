<div class="column_01">
	<div class="menu_inline">
		<ul>
			<li>
				<?php echo anchor('/dashboard/notifications', 'Check for Notifications'); ?>
			</li>
			<li class="selected">
				<?php echo anchor('/dashboard/notifications/notification_options', 'Notification Options'); ?>
			</li>
		</ul>
	</div>
</div>
...
<div class="column_02">
	<div class="content">
		<h2 class="title_02">Notification Options</h2>
		<p>
